      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <a
              href="/asistente"
              className="text-[#712581] hover:text-[#712581] px-3 py-2 text-sm font-medium transition-all duration-300 hover:scale-105 relative group"
            >
              Asistente
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-[#712581] transition-all duration-300"></span>
            </a>
            <a
              href="#"
              className="text-gray-500 hover:text-[#712581] px-3 py-2 text-sm font-medium transition-all duration-300 hover:scale-105 relative group"
        ...
        >
          <nav className="px-4 py-4 bg-white/95 backdrop-blur-md border-t border-gray-100">
            <div className="space-y-2">
              ...
              <a
                href="/asistente"
                className="block px-3 py-2 text-[#712581] bg-[#712581]/10 rounded-lg transition-all duration-200 font-medium"
                onClick={() => setIsMenuOpen(false)}
              >
                Asistente
              </a>
